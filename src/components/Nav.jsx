                    ...
                    <div className="container-fluid px-0">
                        ...
                        <div className="collapse navbar-collapse pt-3 pb-2 py-lg-0 w-100" id="navigation">
                            <ul className="navbar-nav navbar-nav-hover w-100">
                                <li className="nav-item dropdown dropdown-hover mx-2">
                                    ...
                                    <div className="dropdown-menu dropdown-menu-animation dropdown-md p-3 border-radius-lg mt-0 mt-lg-3" aria-labelledby="dropdownMenuPages">
                                        ...
                                        <div className="d-lg-none">
                                            ...
                                            <div
                                                className="dropdown-header text-dark font-weight-bolder d-flex justify-content-cente align-items-center px-0 mt-3">
                                                <div className="d-inline-block">
                                                    <div className="border-radius-md text-center me-2 d-flex align-items-center justify-content-center ps-0">
                                                        <Iconprofile />
                                                    </div>
                                ...
                                <li className="nav-item dropdown dropdown-hover mx-2">
                                    <a className="nav-link ps-2 d-flex justify-content-between cursor-pointer align-items-center" href="javascript:;" id="dropdownMenuBlocks" data-bs-toggle="dropdown" aria-expanded="false"> Blocks
                                        <Icondownarrow />
                                    </a>
                                    <ul className="dropdown-menu dropdown-menu-animation dropdown-lg dropdown-lg-responsive p-3 border-radius-lg mt-0 mt-lg-3"
                                                ...
                                                <a className="dropdown-item py-2 ps-3 border-radius-md"
                                                    ...
                                                    <div className="d-flex">
                                                        <div className="icon h-10 me-3 d-flex mt-1">
                                                            <i
                                                                className="ni ni-single-copy-04 text-gradient text-primary"></i>
                                                        </div>
                                                        <div
                                            ...
                                            <li className="nav-item dropdown dropdown-hover dropdown-subitem">
                                                <a className="dropdown-item py-2 ps-3 border-radius-md"
                                                    ...
                                                    <div className="d-flex">
                                                        <div className="icon h-10 me-3 d-flex mt-1">
                                                            <i
                                                                className="ni ni-notification-70 text-gradient text-primary"></i>
                                                        </div>
                                                        <div
                                                            className="w-100 d-flex align-items-center justify-content-between">
                                                            <div>
                                ...
                                <li className="nav-item dropdown dropdown-hover mx-2">
                                    <a className="nav-link ps-2 d-flex justify-content-between cursor-pointer align-items-center" href="javascript:;" id="dropdownMenuDocs" data-bs-toggle="dropdown" aria-expanded="false"> Docs
                                        <Icondownarrow />
                                    </a>
                                    <div className="dropdown-menu dropdown-menu-animation dropdown-lg mt-0 mt-lg-3 p-3 border-radius-lg"
                                            ...
                                            <ul className="list-group">
                                                <li className="nav-item list-group-item border-0 p-0">
                                                    <a className="dropdown-item py-2 ps-3 border-radius-md"
                                                        ...
                                                        <div className="d-flex">
                                                            <div className="icon h-10 me-3 d-flex mt-1">
                                                                <svg className="text-secondary" width="16px" height="16px"
                                                                        ...
                                                                        <g transform="translate(-1720.000000, -592.000000)"
                                                                            ...
                                                                            <g
                                                                                ...
                                                                                <g
                                                                                    ...
                                                                                    <path className="color-background"
                                                                                        d="M17.2616667,3.90166667 C12.4943643,3.07192755 7.62174065,4.61673894 4.20333333,8.04166667 C3.31200265,8.94126033 2.53706177,9.94913142 1.89666667,11.0416667 C1.5109569,11.6966059 1.61721591,12.5295394 2.155,13.0666667 L5.47,16.3833333 C8.55036617,11.4946947 12.5559074,7.25476565 17.2616667,3.90166667 Z"
                                                                                        opacity="0.598539807"></path>
                                                                                    <path className="color-background"
                                                                                        d="M36.0983333,22.7383333 C36.9280725,27.5056357 35.3832611,32.3782594 31.9583333,35.7966667 C31.0587397,36.6879974 30.0508686,37.4629382 28.9583333,38.1033333 C28.3033941,38.4890431 27.4704606,38.3827841 26.9333333,37.845 L23.6166667,34.53 C28.5053053,31.4496338 32.7452344,27.4440926 36.0983333,22.7383333 Z"
                                                                                        opacity="0.598539807"></path>
                                                                                </g>
                                                                            </g>
                                                                        </g>
                                                            ...
                                                            <div>
                                                                <h6
                                                                    className="dropdown-header text-dark font-weight-bolder d-flex justify-content-cente align-items-center p-0">
                                                                    Getting Started</h6>
                                                                <span className="text-sm">All about overview, quick start,
                                                        ...
                                                        <div className="d-flex">
                                                            ...
                                                            <div>
                                                                <h6
                                                                    className="dropdown-header text-dark font-weight-bolder d-flex justify-content-cente align-items-center p-0">
                                                                    Foundation</h6>
                                                                <span className="text-sm">See our colors, icons and
                                                                    typography</span>
                                                            </div>
                                                        </div>
                                                    </a>
                                                        ...
                                                        <div className="d-flex">
                                                            ...
                                                            <div>
                                                                <h6
                                                                    className="dropdown-header text-dark font-weight-bolder d-flex justify-content-cente align-items-center p-0">
                                                                    Components</h6>
                                                                <span className="text-sm">Explore our collection of fully
                                                        ...
                                                        <div className="d-flex">
                                                            ...
                                                            <div>
                                                                <h6
                                                                    className="dropdown-header text-dark font-weight-bolder d-flex justify-content-cente align-items-center p-0">
                                                                    Plugins</h6>
                                                                <span className="text-sm">Check how you can integrate our
                                                                    plugins</span>
                                                            </div>
                                                        </div>
                                                    </a>
                                                    ...
                                                    <a className="dropdown-item py-2 ps-3 border-radius-md" href="  ">
                                                        <div className="d-flex">
                                                                        ...
                                                                        <g transform="translate(-2020.000000, -442.000000)"
                                                                            ...
                                                                            <g
                                                                                ...
                                                                                <g
                                                                                    ...
                                                                                    <polygon className="color-background"
                                                                                        opacity="0.596981957"
                                                            ...
                                                            <div>
                                                                <h6
                                                                    className="dropdown-header text-dark font-weight-bolder d-flex justify-content-cente align-items-center p-0">
                                                                    Utility classNamees</h6>
                                                                <span className="text-sm">For those who want flexibility,
                                                                    use
                                                                    our utility classNamees</span>
                                                            </div>
                                                        </div>
                                                    </a>
                                                </li>
                                ...
                                <li className="nav-item ms-auto d-flex align-items-center justify-content-center gap-4 text-center">
                                    <h1 className="fs-4 align-items-center justify-content-center text-center mt-2"><span id="realtime-clock"></span></h1>
                                    <a className="btn btn-sm btn-outline-primary btn-round mb-0 me-5 mt-2 mt-md-0">Online Example Code</a>
                                </li>
                            </ul>
                        </div>
                    </div>
